...
exports.SimpleAnalysisController = void 0;
const simple_analysis_service_1 = require("../services/simple-analysis.service");
class SimpleAnalysisController {
    constructor() {
        this.analysisService = new simple_analysis_service_1.SimpleAnalysisService();
    }
    /**
     * 生成基础分析报告
     */
     ...
     * 提取人格画像数据
     */
    extractPersonalityProfile(userAnswers) {
        // 简化的人格画像提取
        return {
     ...
     * 生成可视化数据
     */
    generateVisualizationData(userAnswers, analysisResult) {
        ...
        return {
            ...
            careerFitChart: {
                ...
                data: {
                    ...
                    datasets: [{
                            label: '职业匹配度',
                            data: analysisResult.careerRecommendations.slice(0, 5).map((_, index) => 90 - index * 8),
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.8)',
                                'rgba(54, 162, 235, 0.8)',
                                'rgba(255, 205, 86, 0.8)',
...
exports.SimpleAnalysisController = SimpleAnalysisController;
