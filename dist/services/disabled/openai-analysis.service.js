...
exports.OpenAIAnalysisService = void 0;
const database_logger_service_1 = require("./database-logger.service");
const mcp_knowledge_service_1 = require("./mcp-knowledge.service");
...
class OpenAIAnalysisService {
     ...
     * 构建分析提示词
     */
    buildAnalysisPrompt(request, knowledge) {
...
`;
     ...
     * 调用OpenAI API
     */
    async callOpenAI(prompt, language = 'zh') {
        if (!this.openaiApiKey) {
     ...
     * 解析分析结果
     */
    parseAnalysisResult(openaiResponse) {
        try {
            // 清理可能的markdown格式
     ...
     * 生成可视化数据
     */
    generateVisualizationData(userAnswers, report) {
        return {
            personalityChart: {
                type: 'radar',
                data: {
     ...
     * 计算分析可信度
     */
    calculateConfidence(userAnswers, knowledge) {
...
exports.OpenAIAnalysisService = OpenAIAnalysisService;
